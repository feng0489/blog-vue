...
let pages = handleEntry('./src/app/**?/*.html')
console.log(pages)
...
module.exports = {
    ...
    devServer: {
        ...
        //     });
        // },
        proxy: 'http://localhost:8856', // 配置跨域处理,只有一个代理
        // 配置多个代理
        // proxy: {
        //     "/api": {
        //         target: "http://localhost:8856/api",// 要访问的接口域名
