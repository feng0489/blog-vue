    ...
    <div class="add-admin">
        <div class="header-tages">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item :to="{ path: '/admin/sys/tags' }">标签列表</el-breadcrumb-item>
                <el-breadcrumb-item>{{nowBread}}</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <el-form ref="form" :model="form"  label-width="80px">
            <el-form-item label="名 称">
                <el-input style="width: 200px;" v-model="form.tagname"></el-input>
            </el-form-item>
            <el-form-item>
    ...
    export default {
        ...
        created:function (){
            ...
            if(this.$route.params.tagname){
                this.form.tagname=this.$route.params.tagname
            }
        ...
        methods: {
            onSubmit() {
                if(this.form.type===0){//新增
                    this.$http.get("/api/admin/tags/add",{
                        params: {
                    ...
                    this.$http.get("/api/admin/tags/up",{
                        params: {
                            id: this.form.id,
                            tagname: this.form.tagname,
                        }
